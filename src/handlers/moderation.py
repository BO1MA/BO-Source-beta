...
def register(app: Application) -> None:
    ...
    app.add_handler(MessageHandler(filters.Regex("^(اطردني|طردني)$") & G, handle_kick_self), group=5)
    ...
    app.add_handler(MessageHandler(filters.Regex("^(حذف|مسح)$") & G, handle_delete_message), group=5)
